...
## Installation Elasticsearch 2.x
    ...
    ./bin/plugin install https://github.com/jprante/elasticsearch-langdetect/releases/download/2.3.3.0/elasticsearch-langdetect-2.4.0.0-plugin.zip
