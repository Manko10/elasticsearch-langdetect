...
## Installation Elasticsearch 2.x
    ...
    ./bin/plugin install https://github.com/phoerious/elasticsearch-langdetect/releases/download/2.4.4.0/elasticsearch-langdetect-2.4.4.0-plugin.zip
